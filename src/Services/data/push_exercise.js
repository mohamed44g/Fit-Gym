...
const push = [
  [
    ...
    { id: 4, name: "4- Shoulder Press", img: sholder_press },
    { id: 5, name: "5- Cable Lateral Raise", img: shoulder_rais },
    { id: 6, name: "6- One Arm Pushdown", img: tricepe_pushdown },
    { id: 7, name: "7- One Arm Overhead", img: tricepe_overhead },
  ],
  ...
  [
    ...
    { id: 4, name: "4- Band pull apart", img: band_apart },
    { id: 5, name: "5- Barbell Shrug", img: burble_shrugs },
  ...
  [
    //day 5 pull
    { id: 1, name: "1- Lat Pulldown", img: lat_pull_down },
    { id: 2, name: "2- Single Arm High Row", img: wing },
    { id: 3, name: "3- Barbell Deadlift", img: dead_left },
    { id: 4, name: "4- Band pull apart", img: band_apart },
    { id: 5, name: "5- Barbell Shrug", img: burble_shrugs },
    { id: 6, name: "6- Concentration Curl", img: concentration_curl },
    { id: 7, name: "7- Hammer Curl", img: Hammer },
  ],
